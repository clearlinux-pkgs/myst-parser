...
%prep
%setup -q -n myst-parser-0.16.0
cd %{_builddir}/myst-parser-0.16.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639417405
...
cp %{_builddir}/myst-parser-0.16.0/LICENSE %{buildroot}/usr/share/package-licenses/myst-parser/ab5a711cce75e49bdbd08bbcb728262e30580e5d
